...
steps[index].classList.add("active");
	...
	function show70(){
	  document.getElementById('div70').style.display = 'block';
	}
	function show71(){
		document.getElementById('div71').style.display = 'block';
	}
	function show72(){
		document.getElementById('div72').style.display = 'block';
	}
	function show73(){
		  document.getElementById('div73').style.display = 'block';
	}
	function show74(){
		document.getElementById('div74').style.display = 'block';
	}
	function show75(){
		document.getElementById('div75').style.display = 'block';
	}
	function show76(){
		document.getElementById('div76').style.display = 'block';
	}
